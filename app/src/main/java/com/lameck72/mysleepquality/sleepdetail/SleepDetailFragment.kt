package com.lameck72.mysleepquality.sleepdetail
...
import com.lameck72.mysleepquality.databinding.FragmentSleepDetailBinding
...
class SleepDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = arguments?.sleepNightKey?.let { SleepDetailViewModelFactory(it, dataSource) }
