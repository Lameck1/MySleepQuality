...
import com.lameck72.mysleepquality.databinding.ListItemSleepNightBinding
...
class SleepNightAdapter(val clickListener: SleepNightListener):
     ...
     *  So the onBindViewHolder() method takes two arguments: a view
     *  holder, and a position of the data to bind. For this app,
     *  the holder is the TextItemViewHolder, and the position is the
